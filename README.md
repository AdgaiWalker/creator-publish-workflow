...
如果还需要把内容继续做成图文卡片或标题动效，这个仓库现在也补了两个视觉支持工具：

- [信息卡截图生成器](./信息卡截图生成器/README.md)
- [SVG组装动画器](./SVG组装动画器/README.md)
...
除了主链里的两个核心 skill，这个仓库还收了两类更偏视觉交付的工具：
